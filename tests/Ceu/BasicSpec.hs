...
spec = do
  ...
  describe "declarations" $ do
    ...
    it "Bool ; (True == False)" $
      (fst $ TypeSys.go
        ...
        (Var annz "==" (TypeF (TypeN [(TypeD ["Bool"] Type0),(TypeD ["Bool"] Type0)]) (TypeD ["Bool"] Type0),cz)
  ...
  describe "checkTypeSys -- declarations" $ do
    ...
    checkCheckIt (prelude annz (Var annz "a" (TypeD ["Int"] Type0,cz) (Match annz False (LVar "a") (Number annz 1) (Nop annz) (Nop annz)))) []
    checkCheckIt (prelude annz (Var annz "a" (TypeN [TypeD ["Int"] Type0,TypeD ["Int"] Type0],cz) (Match annz False (LVar "a") (Number annz 1) (Nop annz) (Nop annz)))) ["types do not match : expected '(Int,Int)' : found 'Int.1'"]
    ...
    it "a:Int ; True <- a" $
      (fst $ TypeSys.go (prelude annz (Var annz "a" (TypeD ["Int"] Type0,cz) (Match annz True (LCons ["Bool","True"] LUnit) (Read annz "a") (Nop annz) (Nop annz)))))
        `shouldBe` ["types do not match : expected 'Bool' : found 'Int'"]

    it "a:Bool ; True <- a" $
      (fst $ TypeSys.go (prelude annz (Var annz "a" (TypeD ["Bool"] Type0,cz) (Match annz True (LCons ["Bool","True"] LUnit) (Read annz "a") (Nop annz) (Nop annz)))))
        `shouldBe` []
    it "a:Bool ; True <- a" $
      (fst $ TypeSys.go (prelude annz (Var annz "a" (TypeD ["Bool"] Type0,cz) (Match annz False (LCons ["Bool","True"] LUnit) (Read annz "a") (Nop annz) (Nop annz)))))
    ...
    checkCheckIt (prelude annz (Var annz "umn" (TypeF (TypeD ["Int"] Type0) (TypeD ["Int"] Type0),cz) (Var annz "a" (TypeD ["Int"] Type0,cz) (Match annz False (LVar "a") (Call annz (Read annz "umn") (Read annz "b")) (Nop annz) (Nop annz))))) ["variable 'b' is not declared"]


    it "a:() ; a <- -1" $
      (fst $ TypeSys.go
        (prelude annz
        (Var annz "umn" (TypeF (TypeD ["Int"] Type0) (TypeD ["Int"] Type0),cz)
        (Var annz "a" (Type0,cz)
  ...
  checkCheckIt (prelude annz (Var annz "x" (TypeD ["Int"] Type0,cz) (Match annz False (LVar "x") (Unit annz) (Nop annz) (Nop annz)))) ["types do not match : expected 'Int' : found '()'"]
  checkCheckIt (prelude annz (Var annz "identity" (TypeF (TypeV "a") (TypeV "a"),cz) (Var annz "a" (TypeD ["Int"] Type0,cz) (Match annz False (LVar "a") (Call annz (Read annz "identity") (Number annz 1)) (Nop annz) (Nop annz))))) []
  ...
  describe "write" $ do
    ...
    it "ret = f()" $
      (fst $ TypeSys.go
        (Data annz ["Int"] (Type0,cz) False
        (Var annz "f" (TypeF Type0 (TypeD ["Int"] Type0),cz)
        (Var annz "ret" (TypeT,cz)
  ...
  describe "write!" $ do
    it "1 <- ret" $
      (fst $ TypeSys.go
        (Data annz ["Int"] (Type0,cz) False
        (Var annz "ret" (TypeD ["Int"] Type0,cz)
  ...
  describe "functions" $ do
    it "func ~Int" $
      (fst $ TypeSys.go (Var annz "f" (TypeF Type0 (TypeD ["Int"] Type0),cz) (Nop annz)))
    ...
    it "func first :: (a,a)->a ; var a::Int ; a = first((),1)" $
      (fst $ TypeSys.go (prelude annz (Var annz "first" (TypeF (TypeN [(TypeV "a"),(TypeV "a")]) (TypeV "a"),cz) (Var annz "a" (TypeD ["Int"] Type0,cz) (Match annz False (LVar "a") (Call annz (Read annz "first") (Tuple annz [(Unit annz),(Number annz 1)])) (Nop annz) (Nop annz))))))
        `shouldBe`
    ...
    checkCheckIt (prelude annz (Var annz "first" (TypeF (TypeN [(TypeV "a"),(TypeV "a")]) (TypeV "a"),cz) (Var annz "a" (TypeD ["Int"] Type0,cz) (Match annz False (LVar "a") (Call annz (Read annz "first") (Tuple annz [(Number annz 1),(Number annz 1)])) (Nop annz) (Nop annz))))) []
    ...
    it "f : a -> Int ; return f(1)" $
      (fst $ TypeSys.go
        (Data annz ["Int"] (Type0,cz) False
        (Var annz "f" (TypeF (TypeV "a") (TypeD ["Int"] Type0),cz)
    ...
    it "Int ; X a ; inst X Int ; return fff 1" $
      (fst $ TypeSys.go $ Simplify.go
        (Data annz ["Int"] (Type0,cz) False
        (Class annz "X" (cv "a") [(annz,"fff",(TypeF (TypeV "a") (TypeD ["Int"] Type0),cvc ("a","X")),False)]
            (Var annz "fff" (TypeF (TypeV "a") (TypeD ["Int"] Type0),cvc ("a","X"))
        (Inst annz "X" (TypeD ["Int"] Type0,cz)
            [(annz,"fff",(TypeF (TypeD ["Int"] Type0) (TypeD ["Int"] Type0),cz),True)]
            (Var annz "fff" (TypeF (TypeD ["Int"] Type0) (TypeD ["Int"] Type0),cz)
            (Match annz False
              (LVar "fff")
              (Func annz (TypeF (TypeD ["Int"] Type0) (TypeD ["Int"] Type0),cz)
  ...
  describe "pattern matching" $ do
    ...
    it "(x,_) = 1" $
      TypeSys.go (prelude annz
            (Var annz "x" (TypeD ["Int"] Type0,cz)
              (Match annz False (LTuple [LVar "x", LAny]) (Number annz 1) (Nop annz) (Nop annz))))
      `shouldBe` (["types do not match : expected '(?,?)' : found 'Int.1'"],Data annz ["Int"] (Type0,cz) False (Data annz ["Bool"] (Type0,cz) False (Data annz ["Bool.True"] (Type0,cz) False (Data annz ["Bool.False"] (Type0,cz) False (Var annz{type_=(TypeB,cz)} "x" (TypeD ["Int"] Type0,cz) (Match annz{type_=(TypeB,cz)} False (LTuple [LVar "x",LAny]) (Number annz{type_=(TypeD ["Int","1"] Type0,cz)} 1) (Nop annz) (Nop annz)))))))

    it "(x,_) = (1,1)" $
      TypeSys.go (prelude annz
            (Var annz "x" (TypeD ["Int"] Type0,cz)
              (Match annz False (LTuple [LVar "x", LAny]) (Tuple annz [Number annz 1, Number annz 1]) (Nop annz) (Nop annz))))
      `shouldBe` ([],Data annz ["Int"] (Type0,cz) False (Data annz ["Bool"] (Type0,cz) False (Data annz ["Bool.True"] (Type0,cz) False (Data annz ["Bool.False"] (Type0,cz) False (Var (annz{type_ = (TypeB,cz)}) "x" (TypeD ["Int"] Type0,cz) (Match (annz{type_ = (TypeB,cz)}) False (LTuple [LVar "x",LAny]) (Tuple (annz{type_ = (TypeN [TypeD ["Int","1"] Type0,TypeD ["Int","1"] Type0],cz)}) [Number (annz{type_ = (TypeD ["Int","1"] Type0,cz)}) 1,Number (annz{type_ = (TypeD ["Int","1"] Type0,cz)}) 1]) (Nop annz) (Nop annz)))))))

    it "((_,x),_) = (y,1)" $
      TypeSys.go (prelude annz
            (Var annz "x" (TypeD ["Int"] Type0,cz)
              (Var annz "y" (TypeN [Type0, TypeD ["Int"] Type0],cz)
                (Match annz False
                  (LTuple [LTuple [LAny,LVar "x"], LAny])
                  (Tuple annz [Read annz "y", Number annz 1])
                  (Nop annz)
                  (Nop annz)))))
      `shouldBe` ([],Data annz ["Int"] (Type0,cz) False (Data annz ["Bool"] (Type0,cz) False (Data annz ["Bool.True"] (Type0,cz) False (Data annz ["Bool.False"] (Type0,cz) False (Var (annz{type_ = (TypeB,cz)}) "x" (TypeD ["Int"] Type0,cz) (Var (annz{type_ = (TypeB,cz)}) "y" (TypeN [Type0,TypeD ["Int"] Type0],cz) (Match (annz{type_ = (TypeB,cz)}) False (LTuple [LTuple [LAny,LVar "x"],LAny]) (Tuple (annz{type_ = (TypeN [TypeN [Type0,TypeD ["Int"] Type0],TypeD ["Int","1"] Type0],cz)}) [Read (annz{type_ = (TypeN [Type0,TypeD ["Int"] Type0],cz)}) "y",Number annz{type_ = (TypeD ["Int","1"] Type0,cz)} 1]) (Nop annz) (Nop annz))))))))

    it "`a` = 1" $
      TypeSys.go (prelude annz
        (Var annz "a" (TypeD ["Int"] Type0,cz) (Match annz True (LExp $ Read annz "a") (Number annz 1) (Nop annz) (Nop annz))))
      `shouldBe` ([],Data annz ["Int"] (Type0,cz) False (Data annz ["Bool"] (Type0,cz) False (Data annz ["Bool.True"] (Type0,cz) False (Data annz ["Bool.False"] (Type0,cz) False (Var annz "a" (TypeD ["Int"] Type0,cz) (Match annz True (LExp $ Read annz{type_ = (TypeD ["Int"] Type0,cz)} "a") (Number annz{type_=(TypeD ["Int","1"] Type0,cz)} 1) (Nop annz) (Nop annz)))))))
    it "`a` = 1" $
      TypeSys.go (prelude annz
        (Var annz "a" (Type0,cz) (Match annz True (LExp $ Read annz "a") (Number annz 1) (Nop annz) (Nop annz))))
      `shouldBe` (["types do not match : expected '()' : found 'Int.1'"],Data annz ["Int"] (Type0,cz) False (Data annz ["Bool"] (Type0,cz) False (Data annz ["Bool.True"] (Type0,cz) False (Data annz ["Bool.False"] (Type0,cz) False (Var annz "a" (Type0,cz) (Match annz True (LExp $ Read annz{type_ = (Type0,cz)} "a") (Number annz{type_=(TypeD ["Int","1"] Type0,cz)} 1) (Nop annz) (Nop annz)))))))

    it "data X with Int ; x:Int ; X 1 <- X 2" $
      (fst $ TypeSys.go (prelude annz
        (Data annz ["Xxx"] (TypeD ["Int"] Type0,cz) False (Match annz True (LCons ["Xxx"] (LNumber 1)) (Cons annz ["Xxx"] (Number annz 2)) (Ret annz (Number annz 2)) (Nop annz)))))
    ...
    it "A ; A.B ; x:(Int,A.B) ; (1,A) <- x" $
      (fst $ TypeSys.go
        ...
        (Data annz ["A"]     (Type0,cz) True
        (Data annz ["A","B"] (Type0,cz) False
        (Var  annz "x" (TypeN [TypeD ["Int"] Type0, TypeD ["A","B"] Type0],cz)
  ...
  describe "new types" $ do
    ...
    it "~Int / x::Int" $
      (fst $ TypeSys.go
        (Var annz "x" (TypeD ["Int"] Type0,cz) (Nop annz)))
      `shouldBe` ["data 'Int' is not declared"]

    it "x=Bool" $
      (fst $ TypeSys.go
        (Data annz ["Bool"] (Type0,cz) True
          (Var annz "x" (TypeD ["Bool"] Type0,cz)
    ...
    it "Int ; Bool.* ; True <- True==False" $
      (fst $ TypeSys.go
        ...
        (Data annz ["Bool","True"] (Type0,cz) False
        (Data annz ["Bool","False"] (Type0,cz) False
        (Var annz "==" (TypeF (TypeN [(TypeD ["Int"] Type0),(TypeD ["Int"] Type0)]) (TypeD ["Bool"] Type0),cz)
          (Match annz True
            (LCons ["Bool","True"] LUnit)
            (Call annz (Read annz "==")
              (Tuple annz
    ...
    it "~Bool ; x=True" $
      (fst $ TypeSys.go
        (Var annz "x" (TypeD ["Bool"] Type0,cz)
          (Match annz False (LVar "x") (Cons annz{type_=(TypeD ["Bool"] Type0,cz)} ["Bool","True"] (Unit annz)) (Nop annz) (Nop annz))))
  ...
  describe "typeclass:" $ do
    ...
    it "~Bool ; Equalable ; (==)" $
      TypeSys.go
        ...
        (Var annz "==" (TypeF (TypeN [(TypeV "a"),(TypeV "a")]) (TypeD ["Bool"] Type0),cz)
        (Nop annz)))
      `shouldBe` (["data 'Bool' is not declared"],(Var annz "==" (TypeF (TypeN [TypeV "a",TypeV "a"]) (TypeD ["Bool"] Type0),cz) (Nop annz)))
    ...
    it "Bool ; Equalable ; (==)" $
      TypeSys.go
        ...
        (Var annz "==" (TypeF (TypeN [(TypeV "a"),(TypeV "a")]) (TypeD ["Bool"] Type0),cz)
        (Nop annz))))
      `shouldBe` ([],Data annz ["Bool"] (Type0,cz) True (Var annz "==" (TypeF (TypeN [TypeV "a",TypeV "a"]) (TypeD ["Bool"] Type0),cz) (Nop annz)))

    it "Bool ; Equalable ; (==)" $
      TypeSys.go
        (Data annz ["Bool"] (Type0,cz) True
        (Class annz "Equalable" (cv "a") []
        (Var annz "==" (TypeF (TypeN [(TypeV "a"),(TypeV "a")]) (TypeD ["Bool"] Type0), cvc ("a","Equalable"))
        (Nop annz))))
    ...
    it "A ; Xable a ; inst Xable A ; ()/=Int" $
      (fst $ TypeSys.go
        ...
        (Var annz "fff" (TypeF (TypeV "a") Type0,cz)
        (Inst annz "Xable" (TypeD ["A"] Type0,cz)
          [(annz,"fff",(TypeF (TypeD ["A"] Type0) (TypeD ["Int"] Type0),cz),True)]
          (func "$fff$(A -> ())$" (TypeF (TypeD ["A"] Type0) (TypeD ["Int"] Type0),cz)
            (Seq annz
              (Nop annz)
              (Nop annz)))))))))
    ...
    it "A ; Xable a ; inst X A" $
      (fst $ TypeSys.go
        ...
        (Inst annz "X" (TypeD ["A"] Type0,cz)
          [(annz,"fff",(TypeF (TypeD ["Int"] Type0) Type0,cz),True)]
          (func "$fff$(Int -> ())$" (TypeF (TypeD ["Int"] Type0) Type0,cz)
            (Seq annz
              (Nop annz)
              (Nop annz)))))))))
    ...
    it "A ; Xable a ; inst Xable A ; a/=A" $
      (fst $ TypeSys.go
        ...
        (Inst annz "Xable" (TypeD ["A"] Type0,cz)                          -- A
          [(annz, "fff", (TypeF (TypeD ["Int"] Type0) Type0,cz), True)]
          (func "$fff$(Int -> ())$" (TypeF (TypeD ["Int"] Type0) Type0,cz)  -- Int
            (Seq annz
              (Nop annz)
              (Nop annz)))))))))
        ...
        (Match annz False (LVar "$fff$((A,A) -> ())$")
          ...
          (CallS annz
            (Call (annz {type_ = (Type0,cz)})
              ...
              (Tuple
                (annz {type_ = (TypeN [TypeD ["A"] Type0,TypeD ["A"] Type0],cz)}) [Cons (annz {type_ = (TypeD ["A"] Type0,cz)}) ["A"] (Unit (annz {type_ = (Type0,cz)})),Cons (annz {type_ = (TypeD ["A"] Type0,cz)}) ["A"] (Unit (annz {type_ = (Type0,cz)}))])))
          (Ret annz (Error annz 99))))))
    ...
    it "Int ; Bool ; Equalable a ; eq 1 Bool" $
      (fst $ TypeSys.go
        ...
        (Class annz "Equalable" (cv "a") [(annz,"eq",(TypeF (TypeN [(TypeV "a"),(TypeV "a")]) (TypeD ["Bool"] Type0),cz),False)]
        (Var annz "eq" (TypeF (TypeN [(TypeV "a"),(TypeV "a")]) (TypeD ["Bool"] Type0),cz)
    ...
    it "Int ; Bool ; Xable a ; inst Xable Bool/Int ; fff 1 ; fff Bool" $
      (fst $ TypeSys.go
        ...
        (Class annz "Xable" (cv "a") [(annz,"fff",(TypeF (TypeV "a") Type0,cz),False)]
        (Var annz "fff" (TypeF (TypeV "a") Type0,cz)
        (Inst annz "Xable" (TypeD ["Bool"] Type0,cz)
          [(annz, "fff", (TypeF (TypeD ["Bool"] Type0) Type0,cz), True)]
          (func "$fff$(Bool -> ())$" (TypeF (TypeD ["Bool"] Type0) Type0,cz)
            (Seq annz
              (Nop annz)
              (Inst annz "Xable" (TypeD ["Int"] Type0,cz)
                [(annz, "fff", (TypeF (TypeD ["Int"] Type0) Type0,cz), True)]
                (func "$fff$(Int -> ())$" (TypeF (TypeD ["Int"] Type0) Type0,cz)
                  (Seq annz
                    (Nop annz)
