...
spec = do
  ...
  describe "typeclass" $ do
    ...
    it "A ; Xable.fff(a) ; Inst Xable (A,A) ; fff(A,A)" $
      ...
      `shouldBe` (["missing implementation of 'fff'"],Data annz ["A"] [] Type0 False (Var annz "fff" (TypeF (TypeV "a") Type0) (CallS annz (Call (annz {type_ = Type0}) (Read (annz {type_ = TypeF (TypeN [Type1 ["A"],Type1 ["A"]]) Type0}) "fff__((A,A) -> ())") (Tuple (annz {type_ = TypeN [Type1 ["A"],Type1 ["A"]]}) [Cons (annz {type_ = Type1 ["A"]}) ["A"] (Unit (annz {type_ = Type0})),Cons (annz {type_ = Type1 ["A"]}) ["A"] (Unit (annz {type_ = Type0}))])))))
    ...
    it "Int ; Bool ; Xable a ; inst Xable Bool/Int ; fff 1 ; fff Bool" $
      ...
      `shouldBe` (["missing implementation of 'fff'","missing implementation of 'fff'"],Data annz ["Int"] [] Type0 False (Data annz ["Bool"] [] Type0 False (Var annz "fff" (TypeF (TypeV "a") Type0) (Seq annz (CallS annz (Call (annz {type_ = Type0}) (Read (annz {type_ = TypeF (Type1 ["Int"]) Type0}) "fff__(Int -> ())") (Number (annz {type_ = Type1 ["Int","1"]}) 1))) (CallS annz (Call (annz {type_ = Type0}) (Read (annz {type_ = TypeF (Type1 ["Bool"]) Type0}) "fff__(Bool -> ())") (Cons (annz {type_ = Type1 ["Bool"]}) ["Bool"] (Unit (annz {type_ = Type0})))))))))
    ...
    it "A ; A.B ; Xable a ; inst Xable A ; fff A.B (must use A.fff)" $
      ...
      `shouldBe` (["missing implementation of 'fff'"],Data annz ["A"] [] Type0 False (Data annz ["A","B"] [] Type0 False (Var annz "fff" (TypeF (TypeV "a") Type0) (CallS annz (Call (annz {type_ = Type0}) (Read (annz {type_ = TypeF (Type1 ["A"]) Type0}) "fff__(A -> ())") (Cons (annz {type_ = Type1 ["A","B"]}) ["A","B"] (Unit (annz {type_ = Type0}))))))))
    ...
    it "A ; A.B ; Xable a ; inst Xable A/A.B ; fff A.B ; (must use A.B.fff)" $
      (TypeSys.go
        ...
        (Inst annz ("Xable", [Type1 ["A","B"]])
          ...
          (Nop annz))
        (CallS annz (Call annz (Read annz "fff") (Cons annz ["A","B"] (Unit annz))))))))))
      `shouldBe` (["missing implementation of 'fff'","missing implementation of 'fff'"],Data annz ["A"] [] Type0 False (Data annz ["A","B"] [] Type0 False (Var annz "fff" (TypeF (TypeV "a") Type0) (CallS annz (Call (annz {type_ = Type0}) (Read (annz {type_ = TypeF (Type1 ["A","B"]) Type0}) "fff__(A.B -> ())") (Cons (annz {type_ = Type1 ["A","B"]}) ["A","B"] (Unit (annz {type_ = Type0}))))))))
  ...
  describe "return-data polymorphism" $ do
    ...
    it "B ; X.f:()->b ; inst B.f:()->B ; f()" $
      ...
      `shouldBe` (["missing implementation of 'fff'"],Data annz ["B"] [] Type0 False (Var annz "fff" (TypeF Type0 (TypeV "b")) (CallS annz (Call (annz {type_ = Type1 ["B"]}) (Read (annz {type_ = TypeF Type0 (Type1 ["B"])}) "fff__(() -> B)") (Unit (annz {type_ = Type0}))))))
    ...
    it "B ; X.f:a->b ; inst B.f:a->B ; f()" $
      (TypeSys.go
        ...
        (Inst annz ("X", [Type1 ["B"]])
          ...
          (Nop annz))
        (CallS annz (Call annz (Read annz "fff") (Unit annz)))))))
      `shouldBe` (["missing implementation of 'fff'"],Data annz ["B"] [] Type0 False (Var annz "fff" (TypeF (TypeV "a") (TypeV "b")) (CallS annz (Call (annz {type_ = Type1 ["B"]}) (Read (annz {type_ = TypeF (TypeV "a") (Type1 ["B"])}) "fff__(a -> B)") (Unit (annz {type_ = Type0}))))))
    ...
    it "B1 ; B2 ; X.f:a->b ; inst B1.f:a->B1 ; inst B2.f:a->B2 ; b1=f()" $
      ...
      `shouldBe` (["missing implementation of 'fff'","missing implementation of 'fff'"],Data annz ["B1"] [] Type0 False (Data annz ["B2"] [] Type0 False (Var annz "fff" (TypeF (TypeV "a") (TypeV "b")) (Var annz "b1" (Type1 ["B1"]) (Match annz False (LVar "b1") (Call (annz {type_ = Type1 ["B1"]}) (Read (annz {type_ = TypeF (TypeV "a") (Type1 ["B1"])}) "fff__(a -> B1)") (Unit (annz {type_ = Type0}))) (Nop annz) (Nop annz))))))
    ...
    it "B1 ; B2 ; X.f:a->b ; inst B1.f:a->B1 ; inst B2.f:a->B2 ; b2=f()" $
      (TypeSys.go
        ...
        (Match annz False (LVar "b2")
          (Call annz (Read annz "fff") (Unit annz)) (Nop annz) (Nop annz)))))))))
      `shouldBe` (["missing implementation of 'fff'","missing implementation of 'fff'"],Data annz ["B1"] [] Type0 False (Data annz ["B2"] [] Type0 False (Var annz "fff" (TypeF (TypeV "a") (TypeV "b")) (Var annz "b2" (Type1 ["B2"]) (Match annz False (LVar "b2") (Call (annz {type_ = Type1 ["B2"]}) (Read (annz {type_ = TypeF (TypeV "a") (Type1 ["B2"])}) "fff__(a -> B2)") (Unit (annz {type_ = Type0}))) (Nop annz) (Nop annz))))))
