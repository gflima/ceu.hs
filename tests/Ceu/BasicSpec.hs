...
spec = do
  ...
  describe "checkTypeSys -- declarations" $ do
    ...
    checkCheckIt (prelude annz (Var annz "a" (int,cz) (Match annz False (LVar "a") (Number annz 1) (Nop annz) (Nop annz)))) []
    checkCheckIt (prelude annz (Var annz "a" (TypeN [int,int],cz) (Match annz False (LVar "a") (Number annz 1) (Nop annz) (Nop annz)))) ["types do not match : expected '(Int,Int)' : found 'Int.1'"]
  ...
  checkCheckIt (prelude annz (Var annz "identity" (TypeF (TypeV "a") (TypeV "a"),cz) (Var annz "a" (int,cz) (Match annz False (LVar "a") (Call annz (Read annz "identity") (Number annz 1)) (Nop annz) (Nop annz))))) []
...
-}
  ...
  describe "pattern matching" $ do
    it "1 = 1" $
      ...
      `shouldBe` ([],Match annz{type_=(TypeB,cz)} False (LNumber 1) (Number annz{type_=(TypeD ["Int","1"] Type0 Type0,cz)} 1) (Nop annz) (Nop annz))
    it "1 <- 2" $
      TypeSys.go (Match annz True (LNumber 1) (Number annz 2) (Nop annz) (Nop annz))
      `shouldBe` (["types do not match : expected 'Int.1' : found 'Int.2'"],Match annz True (LNumber 1) (Number (annz {type_ = (TypeD ["Int","2"] Type0 Type0,cz)}) 2) (Nop annz) (Nop annz))
    it "_ = 1" $
      TypeSys.go (Match annz False LAny (Number annz 1) (Nop annz) (Nop annz))
      `shouldBe` ([],Match annz{type_=(TypeB,cz)} False LAny (Number annz{type_=(TypeD ["Int","1"] Type0 Type0,cz)} 1) (Nop annz) (Nop annz))
    it "(x,_) = 1" $
      TypeSys.go (prelude annz
            (Var annz "x" (int,cz)
              (Match annz False (LTuple [LVar "x", LAny]) (Number annz 1) (Nop annz) (Nop annz))))
      `shouldBe` (["types do not match : expected '(?,?)' : found 'Int.1'"],Data annz (int,cz) False (Data annz (bool,cz) False (Data annz (boolt,cz) False (Data annz (boolf,cz) False (Var annz{type_=(TypeB,cz)} "x" (int,cz) (Match annz{type_=(TypeB,cz)} False (LTuple [LVar "x",LAny]) (Number annz{type_=(TypeD ["Int","1"] Type0 Type0,cz)} 1) (Nop annz) (Nop annz)))))))

    it "(x,_) = (1,1)" $
      TypeSys.go (prelude annz
            (Var annz "x" (int,cz)
              (Match annz False (LTuple [LVar "x", LAny]) (Tuple annz [Number annz 1, Number annz 1]) (Nop annz) (Nop annz))))
      `shouldBe` ([],Data annz (int,cz) False (Data annz (bool,cz) False (Data annz (boolt,cz) False (Data annz (boolf,cz) False (Var (annz{type_ = (TypeB,cz)}) "x" (int,cz) (Match (annz{type_ = (TypeB,cz)}) False (LTuple [LVar "x",LAny]) (Tuple (annz{type_ = (TypeN [TypeD ["Int","1"] Type0 Type0,TypeD ["Int","1"] Type0 Type0],cz)}) [Number (annz{type_ = (TypeD ["Int","1"] Type0 Type0,cz)}) 1,Number (annz{type_ = (TypeD ["Int","1"] Type0 Type0,cz)}) 1]) (Nop annz) (Nop annz)))))))
            ...
            (Var annz "x" (int,cz)
              (Var annz "y" (TypeN [Type0, int],cz)
                (Match annz False
                  ...
                  (Nop annz)
                  (Nop annz)))))
      `shouldBe` ([],Data annz (int,cz) False (Data annz (bool,cz) False (Data annz (boolt,cz) False (Data annz (boolf,cz) False (Var (annz{type_ = (TypeB,cz)}) "x" (int,cz) (Var (annz{type_ = (TypeB,cz)}) "y" (TypeN [Type0,int],cz) (Match (annz{type_ = (TypeB,cz)}) False (LTuple [LTuple [LAny,LVar "x"],LAny]) (Tuple (annz{type_ = (TypeN [TypeN [Type0,int],TypeD ["Int","1"] Type0 Type0],cz)}) [Read (annz{type_ = (TypeN [Type0,int],cz)}) "y",Number annz{type_ = (TypeD ["Int","1"] Type0 Type0,cz)} 1]) (Nop annz) (Nop annz))))))))

    it "`a` = 1" $
      TypeSys.go (prelude annz
        (Var annz "a" (int,cz) (Match annz True (LExp $ Read annz "a") (Number annz 1) (Nop annz) (Nop annz))))
      `shouldBe` ([],Data annz (int,cz) False (Data annz (bool,cz) False (Data annz (boolt,cz) False (Data annz (boolf,cz) False (Var annz "a" (int,cz) (Match annz True (LExp $ Read annz{type_ = (int,cz)} "a") (Number annz{type_=(TypeD ["Int","1"] Type0 Type0,cz)} 1) (Nop annz) (Nop annz)))))))
    it "`a` = 1" $
      TypeSys.go (prelude annz
        (Var annz "a" (Type0,cz) (Match annz True (LExp $ Read annz "a") (Number annz 1) (Nop annz) (Nop annz))))
      `shouldBe` (["types do not match : expected '()' : found 'Int.1'"],Data annz (int,cz) False (Data annz (bool,cz) False (Data annz (boolt,cz) False (Data annz (boolf,cz) False (Var annz "a" (Type0,cz) (Match annz True (LExp $ Read annz{type_ = (Type0,cz)} "a") (Number annz{type_=(TypeD ["Int","1"] Type0 Type0,cz)} 1) (Nop annz) (Nop annz)))))))

    it "data X with Int ; x:Int ; X 1 <- X 2" $
      (fst $ TypeSys.go (prelude annz
        (Data annz (TypeD ["Xxx"] Type0 int,cz) False (Match annz True (LCons ["Xxx"] (LNumber 1)) (Cons annz ["Xxx"] (Number annz 2)) (Ret annz (Number annz 2)) (Nop annz)))))
    ...
    it "A ; A.B ; A <- A.B" $
      (fst $ TypeSys.go
        (Data annz (TypeD ["A"] Type0 Type0,cz) True
        (Data annz (TypeD ["A","B"] Type0 Type0,cz) False
    ...
    it "A ; A.B ; x:A.B ; A <- x" $
      (fst $ TypeSys.go
        (Data annz (TypeD ["A"]     Type0 Type0,cz) True
        (Data annz (TypeD ["A","B"] Type0 Type0,cz) False
        (Var  annz "x" (TypeD ["A","B"] Type0 Type0,cz)
        (Match annz False (LCons ["A"] LAny) (Cons annz ["A","B"] (Unit annz)) (Nop annz) (Nop annz))))))
      `shouldBe` []

    it "A ; A.B ; A.B <- A" $
      (fst $ TypeSys.go
        (Data annz (TypeD ["A"]     Type0 Type0,cz) False
        (Data annz (TypeD ["A","B"] Type0 Type0,cz) True
        (Match annz True (LCons ["A","B"] LAny) (Cons annz ["A"] (Unit annz)) (Nop annz) (Nop annz)))))
      `shouldBe` ["types do not match : expected 'A.B' : found 'A'"]

    it "A ; A <- 1" $
      (fst $ TypeSys.go (Data annz (TypeD ["A"] Type0 Type0,cz) True (Match annz True (LCons ["A"] LUnit) (Number annz 1) (Nop annz) (Nop annz))))
      `shouldBe` ["types do not match : expected 'A' : found 'Int.1'"]

    it "A ; A <- A 1" $
      (fst $ TypeSys.go (Data annz (TypeD ["A"] Type0 Type0,cz) False (Match annz False (LCons ["A"] LUnit) (Cons annz ["A"] (Number annz 1)) (Nop annz) (Nop annz))))
      `shouldBe` ["types do not match : expected '()' : found 'Int.1'"]

    it "A ; A 1 <- A" $
      (fst $ TypeSys.go (Data annz (TypeD ["A"] Type0 Type0,cz) False (Match annz False (LCons ["A"] (LNumber 1)) (Cons annz ["A"] (Unit annz)) (Nop annz) (Nop annz))))
    ...
    it "A ; A.B ; x:(Int,A.B) ; (1,A) <- x" $
      (fst $ TypeSys.go
        ...
        (Data annz (TypeD ["A"] Type0 Type0,cz) True
        (Data annz (TypeD ["A","B"] Type0 Type0,cz) False
        (Var  annz "x" (TypeN [int, TypeD ["A","B"] Type0 Type0],cz)
  ...
  describe "new types" $ do
    ...
    it "Bool.True (w/o Bool)" $
      (fst $ TypeSys.go
        (Data annz (TypeD ["Bool","True","Xxx"] Type0 Type0,cz) False (Nop annz)))
    ...
    it "~Bool ; x=True" $
      (fst $ TypeSys.go
        (Var annz "x" (bool,cz)
          (Match annz False (LVar "x") (Cons annz{type_=(bool,cz)} ["Bool","True"] (Unit annz)) (Nop annz) (Nop annz))))
      `shouldBe` ["data 'Bool' is not declared","data 'Bool.True' is not declared"]

    it "data X with Int ; x <- X ()" $
      (fst $ TypeSys.go
        (Data annz (TypeD ["X"] Type0 int,cz) False
        (Var annz "x" (TypeD ["X"] Type0 Type0,cz)
    ...
    it "data X with Int" $
      (fst $ TypeSys.go
        (Data annz (TypeD ["X"] Type0 int,cz) False
        (Var annz "x" (TypeD ["X"] Type0 (int),cz)
    ...
    it "data X with Int ; data X.Y with Int" $
      (TypeSys.go
        (Data annz (int,cz) False
        (Data annz (TypeD ["X"]     Type0 int,cz) False
        (Data annz (TypeD ["X","Y"] Type0 int,cz) False
        (Nop annz)))))
      `shouldBe` ([],Data annz (int,cz) False (Data annz (TypeD ["X"] Type0 int,cz) False (Data annz (TypeD ["X","Y"] Type0 int,cz) False (Nop annz))))

    it "data X with (Int,Int)" $
      (fst $ TypeSys.go
        (Data annz (int,cz) False
        (Data annz (TypeD ["X"] Type0 (TypeN [int, int]),cz) False
        (Var annz "x" (TypeD ["X"] Type0 (TypeN [int, int]),cz)
  ...
  describe "typeclass:" $ do
    ...
    it "A ; Xable ; inst ; inst" $
      (fst $ TypeSys.go
        ...
        (Inst annz "Xable" (TypeD ["A"] Type0 Type0,cz)
          [(annz, "fff", (TypeF (TypeD ["A"] Type0 Type0) Type0,cz), True)]
          (func "$fff$(A -> ())$" (TypeF (TypeD ["A"] Type0 Type0) Type0,cz)
            (Seq annz
              (Nop annz)
              (Inst annz "Xable" (TypeD ["A"] Type0 Type0,cz)
                [(annz,"fff",(TypeF (TypeD ["A"] Type0 Type0) Type0,cz),True)]
                (Var annz "$fff$(A -> ())$" (TypeF (TypeD ["A"] Type0 Type0) Type0,cz)
                (Seq annz
                  (Nop annz)
                  (Nop annz))))
            )))))))
    ...
    it "A ; Xable a ; inst Xable A ; ()/=Int" $
      (fst $ TypeSys.go
        ...
        (Var annz "fff1" (TypeF (TypeV "a") Type0,cz)
        (Inst annz "Xable" (TypeD ["A"] Type0 Type0,cz)
          [(annz,"fff2",(TypeF (TypeD ["A"] Type0 Type0) Type0,cz),True)]
          (func "fff2" (TypeF (TypeD ["A"] Type0 Type0) Type0,cz)
            (Seq annz
              (Nop annz)
              (Nop annz))))))))
    ...
    it "A ; Xable a ; inst Xable A ; ()/=Int" $
      (fst $ TypeSys.go
        ...
        (Var annz "fff" (TypeF (TypeV "a") Type0,cz)
        (Inst annz "Xable" (TypeD ["A"] Type0 Type0,cz)
          [(annz,"fff",(TypeF (TypeD ["A"] Type0 Type0) (int),cz),True)]
          (func "$fff$(A -> ())$" (TypeF (TypeD ["A"] Type0 Type0) (int),cz)
            (Seq annz
              (Nop annz)
              (Nop annz)))))))))
    ...
    it "A ; Xable a ; inst X A" $
      (fst $ TypeSys.go
        ...
        (Class annz "Xable" (cv "a") [(annz,"fff",(TypeF (TypeV "a") Type0,cz),False)]
        (Var annz "fff" (TypeF (TypeV "a") Type0,cz)
        (Inst annz "X" (TypeD ["A"] Type0 Type0,cz)
    ...
    it "A ; Xable a ; inst Xable A ; a/=A" $
      (fst $ TypeSys.go
        ...
        (Inst annz "Xable" (TypeD ["A"] Type0 Type0,cz)                          -- A
          [(annz, "fff", (TypeF (int) Type0,cz), True)]
    ...
    it "A ; Xable.fff(a) ; Inst Xable (A,A) ; fff(A,A)" $
      TypeSys.go
        ...
        (Inst annz "Xable" (TypeN [TypeD ["A"] Type0 Type0, TypeD ["A"] Type0 Type0],cz)
          [(annz, "fff", (TypeF (TypeN [TypeD ["A"] Type0 Type0, TypeD ["A"] Type0 Type0]) Type0,cz), True)]
          (func "$fff$((A,A) -> ())$" (TypeF (TypeN [TypeD ["A"] Type0 Type0, TypeD ["A"] Type0 Type0]) Type0,cz)
            (CallS annz (Call annz (Read annz "fff") (Tuple annz [(Cons annz ["A"] (Unit annz)),(Cons annz ["A"] (Unit annz))]))))))))
      `shouldBe` ([],
        Data annz (TypeD ["A"] Type0 Type0,cz) False
        (Var annz "$fff$((A,A) -> ())$" (TypeF (TypeN [TypeD ["A"] Type0 Type0,TypeD ["A"] Type0 Type0]) Type0,cz)
        (Var annz "$fff$((A,A) -> ())$" (TypeF (TypeN [TypeD ["A"] Type0 Type0,TypeD ["A"] Type0 Type0]) Type0,cz)
        (Match annz False (LVar "$fff$((A,A) -> ())$")
          (Func (annz {type_ = (TypeF (TypeN [TypeD ["A"] Type0 Type0,TypeD ["A"] Type0 Type0]) Type0,cz)}) (TypeF (TypeN [TypeD ["A"] Type0 Type0,TypeD ["A"] Type0 Type0]) Type0,cz) (Ret annz (Error annz 99)))
          (CallS annz
            (Call (annz {type_ = (Type0,cz)})
              (Read (annz {type_ = (TypeF (TypeN [TypeD ["A"] Type0 Type0,TypeD ["A"] Type0 Type0]) Type0,cz)}) "$fff$((A,A) -> ())$")
              (Tuple
                (annz {type_ = (TypeN [TypeD ["A"] Type0 Type0,TypeD ["A"] Type0 Type0],cz)}) [Cons (annz {type_ = (TypeD ["A"] Type0 Type0,cz)}) ["A"] (Unit (annz {type_ = (Type0,cz)})),Cons (annz {type_ = (TypeD ["A"] Type0 Type0,cz)}) ["A"] (Unit (annz {type_ = (Type0,cz)}))])))
          (Ret annz (Error annz 99))))))
    ...
    it "Int ; Bool ; Xable a ; inst Xable Bool/Int ; fff 1 ; fff Bool" $
      ...
      `shouldBe` [] --,Data annz ["Int"] [] Type0 Type0 False (Data annz ["Bool"] [] Type0 Type0 False (Var annz "fff" (TypeF (TypeV "a" ["Xable"]) Type0) (Var annz "fff$(Bool -> ())" (TypeF (TypeD ["Bool"]) Type0) (Var annz "fff$(Int -> ())" (TypeF (TypeD ["Int"]) Type0) (Seq annz (CallS annz (Call (annz {type_ = (Type0,[]}) (Read (annz {type_ = (TypeF (TypeD ["Int"]) Type0,[]}) "fff$(Int -> ())") (Number (annz {type_ = (TypeD ["Int","1"],[]}) 1))) (CallS annz (Call (annz {type_ = (Type0,[]}) (Read (annz {type_ = (TypeF (TypeD ["Bool"]) Type0,[]}) "fff$(Bool -> ())") (Cons (annz {type_ = (TypeD ["Bool"],[]}) ["Bool"] (Unit (annz {type_ = (Type0,[]})))))))))))
    ...
    it "A ; A.B ; Xable a ; inst Xable A ; fff A.B (must use A.fff)" $
      ...
      `shouldBe` [] --,Data annz ["A"] [] Type0 Type0 False (Data annz ["A","B"] [] Type0 Type0 False (Var annz "fff" (TypeF (TypeV "a" ["Xable"]) Type0) (Var annz "fff$(A -> ())" (TypeF (TypeD ["A"]) Type0) (CallS annz (Call (annz {type_ = (Type0,[]}) (Read (annz {type_ = (TypeF (TypeD ["A"]) Type0,[]}) "fff$(A -> ())") (Cons (annz {type_ = (TypeD ["A","B"],[]}) ["A","B"] (Unit (annz {type_ = (Type0,[]})))))))))
      ...
      (fst $ TypeSys.go
        ...
        (Inst annz "Xable" (TypeD ["A"] Type0 Type0,cz)
          ...
          (func "$fff$(A -> ())$" (TypeF (TypeD ["A"] Type0 Type0) Type0,cz)
            (Seq annz
              (Nop annz)
              (Inst annz "Xable" (TypeD ["A","B"] Type0 Type0,cz)
                [(annz, "fff", (TypeF (TypeD ["A","B"] Type0 Type0) Type0,cz), True)]
                (func "$fff$((A,B) -> ())$" (TypeF (TypeD ["A","B"] Type0 Type0) Type0,cz)
                  (Seq annz
                    (Nop annz)
                    (CallS annz (Call annz (Read annz "fff") (Cons annz ["A","B"] (Unit annz)))))))))))))))
      `shouldBe` [] --,Data annz ["A"] [] Type0 Type0 False (Data annz ["A","B"] [] Type0 Type0 False (Var annz "fff" (TypeF (TypeV "a" ["Xable"]) Type0) (Var annz "fff$(A -> ())" (TypeF (TypeD ["A"]) Type0) (Var annz "fff$(A.B -> ())" (TypeF (TypeD ["A","B"]) Type0) (CallS annz (Call (annz {type_ = (Type0,[]}) (Read (annz {type_ = (TypeF (TypeD ["A","B"]) Type0,[]}) "fff$(A.B -> ())") (Cons (annz {type_ = (TypeD ["A","B"],[]}) ["A","B"] (Unit (annz {type_ = (Type0,[]}))))))))))
  ...
  describe "return-data polymorphism" $ do
    ...
    it "B ; X.f:()->b ; inst B.f:()->B ; f()" $
      (fst $ TypeSys.go
        (Data annz (TypeD ["B"] Type0 Type0,cz) False
        (Class annz "X" (cv "b") [(annz,"fff",(TypeF Type0 (TypeV "b"),cz),False)]
        (Var annz "fff" (TypeF Type0 (TypeV "b"),cz)
        (Inst annz "X" (TypeD ["B"] Type0 Type0,cz)
          [(annz, "fff", (TypeF Type0 (TypeD ["B"] Type0 Type0),cz), True)]
          (func "$fff$(() -> B)$" (TypeF Type0 (TypeD ["B"] Type0 Type0),cz)
            (Seq annz
              (Nop annz)
              (CallS annz (Call annz (Read annz "fff") (Unit annz))))))))))
      `shouldBe` [] --,Data annz ["B"] [] Type0 Type0 False (Var annz "fff" (TypeF Type0 (TypeV "b" ["X"])) (Var annz "fff$(() -> B)" (TypeF Type0 (TypeD ["B"])) (CallS annz (Call (annz {type_ = (TypeD ["B"],[]}) (Read (annz {type_ = (TypeF Type0 (TypeD ["B"]),[]}) "fff$(() -> B)") (Unit (annz {type_ = (Type0,[]})))))))
    ...
    it "B ; X.f:a->b ; inst B.f:a->B ; f()" $
      (fst $ TypeSys.go
        ...
        (Inst annz "X" (TypeD ["B"] Type0 Type0,cz)
          [(annz, "fff", (TypeF (TypeV "a") (TypeD ["B"] Type0 Type0),cz), True)]
          (func "$fff$(a -> B)$" (TypeF (TypeV "a") (TypeD ["B"] Type0 Type0),cz)
            (Seq annz
              (Nop annz)
              (CallS annz (Call annz (Read annz "fff") (Unit annz))))))))))
      `shouldBe` [] --,Data annz ["B"] [] Type0 Type0 False (Var annz "fff" (TypeF (TypeV "a" []) (TypeV "b" ["X"])) (Var annz "fff$(a -> B)" (TypeF (TypeV "a" []) (TypeD ["B"])) (CallS annz (Call (annz {type_ = (TypeD ["B"],[]}) (Read (annz {type_ = (TypeF (TypeV "a" []) (TypeD ["B"]),[]}) "fff$(a -> B)") (Unit (annz {type_ = (Type0,[]})))))))

    it "B1 ; B2 ; X.f:a->b ; inst B1.f:a->B1 ; inst B2.f:a->B2 ; f()" $
      (fst $ TypeSys.go
        (Data annz (TypeD ["B1"] Type0 Type0,cz) False
        (Data annz (TypeD ["B2"] Type0 Type0,cz) False
        (Class annz "X" (cv "b") [(annz,"fff",(TypeF (TypeV "a") (TypeV "b"),cz),False)]
        (Var annz "fff" (TypeF (TypeV "a") (TypeV "b"),cz)
        (Inst annz "X" (TypeD ["B1"] Type0 Type0,cz)
          [(annz, "fff", (TypeF (TypeV "a") (TypeD ["B1"] Type0 Type0),cz), True)]
          (func "$fff$(a -> B)$" (TypeF (TypeV "a") (TypeD ["B1"] Type0 Type0),cz)
            (Seq annz
              (Nop annz)
              (Inst annz "X" (TypeD ["B2"] Type0 Type0,cz)
                [(annz, "fff", (TypeF (TypeV "a") (TypeD ["B2"] Type0 Type0),cz), True)]
                (func "$fff$(a -> B2)$" (TypeF (TypeV "a") (TypeD ["B2"] Type0 Type0),cz)
                  (Seq annz
                    (Nop annz)
                    (CallS annz (Call annz (Read annz "fff") (Unit annz))))))))))))))
                  -- the problem is that CallS accept any return data
      `shouldBe` [] --,Data annz ["B1"] [] Type0 Type0 False (Data annz ["B2"] [] Type0 Type0 False (Var annz "fff" (TypeF (TypeV "a" []) (TypeV "b" ["X"])) (Var annz "fff$(a -> B1)" (TypeF (TypeV "a" []) (TypeD ["B1"])) (Var annz "fff$(a -> B2)" (TypeF (TypeV "a" []) (TypeD ["B2"])) (CallS annz (Call (annz {type_ = (TypeD ["B2"],[]}) (Read (annz {type_ = (TypeF (TypeV "a" []) (TypeD ["B2"]),[]}) "fff$(a -> B2)") (Unit (annz {type_ = (Type0,[]})))))))))
    ...
    it "B1 ; B2 ; X.f:a->b ; inst B1.f:a->B1 ; inst B2.f:a->B2 ; b1=f()" $
      (fst $ TypeSys.go
        ...
        (Inst annz "X" (TypeD ["B1"] Type0 Type0,cz)
          [(annz, "fff", (TypeF (TypeV "a") (TypeD ["B1"] Type0 Type0),cz), True)]
          (func "$fff$(a -> B1)$" (TypeF (TypeV "a") (TypeD ["B1"] Type0 Type0),cz)
            (Seq annz
              (Nop annz)
              (Inst annz "X" (TypeD ["B2"] Type0 Type0,cz)
                [(annz, "fff", (TypeF (TypeV "a") (TypeD ["B2"] Type0 Type0),cz), True)]
                (func "$fff$(a -> B2)$" (TypeF (TypeV "a") (TypeD ["B2"] Type0 Type0),cz)
                  (Seq annz
                    (Nop annz)
                    (Var annz "b1" (TypeD ["B1"] Type0 Type0,cz)
                    (Match annz False (LVar "b1")
                      (Call annz (Read annz "fff") (Unit annz)) (Nop annz) (Nop annz))))))))))))))
      `shouldBe` [] --,Data annz ["B1"] [] Type0 Type0 False (Data annz ["B2"] [] Type0 Type0 False (Var annz "fff" (TypeF (TypeV "a" []) (TypeV "b" ["X"])) (Var annz "fff$(a -> B1)" (TypeF (TypeV "a" []) (TypeD ["B1"])) (Var annz "fff$(a -> B2)" (TypeF (TypeV "a" []) (TypeD ["B2"])) (Var annz "b1" (TypeD ["B1"]) (Match annz False (LVar "b1") (Call (annz {type_ = (TypeD ["B1"],[]}) (Read (annz {type_ = (TypeF (TypeV "a" []) (TypeD ["B1"]),[]}) "fff$(a -> B1)") (Unit (annz {type_ = (Type0,[]}))) (Nop annz) (Nop annz))))))))
            ...
            (Seq annz
              ...
              (Inst annz "X" (TypeD ["B2"] Type0 Type0,cz)
                ...
                (func "$fff$(a -> B2)$" (TypeF (TypeV "a") (TypeD ["B2"] Type0 Type0),cz)
                  (Seq annz
                    (Nop annz)
                    (Var annz "b2" (TypeD ["B2"] Type0 Type0,cz)
                    (Match annz False (LVar "b2")
                      (Call annz (Read annz "fff") (Unit annz)) (Nop annz) (Nop annz))))))))))))))
      `shouldBe` [] --,Data annz ["B1"] [] Type0 Type0 False (Data annz ["B2"] [] Type0 Type0 False (Var annz "fff" (TypeF (TypeV "a" []) (TypeV "b" ["X"])) (Var annz "fff$(a -> B1)" (TypeF (TypeV "a" []) (TypeD ["B1"])) (Var annz "fff$(a -> B2)" (TypeF (TypeV "a" []) (TypeD ["B2"])) (Var annz "b2" (TypeD ["B2"]) (Match annz False (LVar "b2") (Call (annz {type_ = (TypeD ["B2"],[]}) (Read (annz {type_ = (TypeF (TypeV "a" []) (TypeD ["B2"]),[]}) "fff$(a -> B2)") (Unit (annz {type_ = (Type0,[]}))) (Nop annz) (Nop annz))))))))
