...
prelude z p =
    ...
    (Seq z (Var  z "_true" False  (TypeD ["Bool"]))
    (Seq z (Set  z False (LVar "_true") (Cons z ["Bool","True"] (Unit z)))
    (Seq z (Var  z "print"  False (TypeF (TypeV "?" [])                         (TypeV "?" [])))
    (Seq z (Var  z "negate" False (TypeF (TypeD ["Int"])                        (TypeD ["Int"])))
    (Seq z (Var  z "=="     False (TypeF (TypeN [TypeD ["Int"], TypeD ["Int"]]) (TypeD ["Bool"])))
    (Seq z (Var  z "<="     False (TypeF (TypeN [TypeD ["Int"], TypeD ["Int"]]) (TypeD ["Bool"])))
    (Seq z (Var  z "<"      False (TypeF (TypeN [TypeD ["Int"], TypeD ["Int"]]) (TypeD ["Bool"])))
    (Seq z (Var  z "+"      False (TypeF (TypeN [TypeD ["Int"], TypeD ["Int"]]) (TypeD ["Int"])))
    (Seq z (Var  z "-"      False (TypeF (TypeN [TypeD ["Int"], TypeD ["Int"]]) (TypeD ["Int"])))
    (Seq z (Var  z "/"      False (TypeF (TypeN [TypeD ["Int"], TypeD ["Int"]]) (TypeD ["Int"])))
    (Seq z (Var  z "*"      False (TypeF (TypeN [TypeD ["Int"], TypeD ["Int"]]) (TypeD ["Int"])))
           p)))))))))))))))
