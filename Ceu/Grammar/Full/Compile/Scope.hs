...
remSVarSGen (SVarS z var _ tp ini p) = SVarS' z var tp ini p
remSVarSGen p = p
...
setScope (SVar'    z var gen tp ini)   = SVarS   z var gen tp  ini   (SNop z)
...
setScope (SSeq _ (SVarS   z var gen tp ini   (SNop _)) p2) = SVarS   z var gen tp  ini   p2
