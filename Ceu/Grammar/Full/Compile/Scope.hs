...
stmt :: Stmt -> Stmt
stmt (Class z me ext ifc)            = Class' z me ext (stmt ifc) (Nop z)
stmt (Inst  z me imp)                = Inst'  z me     (stmt imp) (Nop z)
...
stmt (Seq _ s@(Class z me ext ifc) p2) = Class' z me ext (stmt ifc) (stmt p2)
stmt (Seq _ s@(Inst  z me     imp) p2) = Inst'  z me     (stmt imp) (stmt p2)
