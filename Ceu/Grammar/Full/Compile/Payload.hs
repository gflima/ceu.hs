...
aux (AwaitInp z ext (Just var)) = Seq z (AwaitInp z ext Nothing) (Write z (LVar var) (Read z "_INPUT"))
aux (AwaitEvt z int (Just var)) = Seq z (AwaitEvt z int Nothing) (Write z (LVar var) (Read z ("_"++int)))
...
aux (Every z evt (Just var) p)  = Every z evt Nothing
                                     (Seq z (Write z (LVar var) (Read z inp)) (aux p))
                                  where
