...
getAnnS (Out      z _ _  ) = z
getAnnS (Evt      z _ _  ) = z
getAnnS (Func     z _ _  ) = z
getAnnS (FuncI    z _ _ _) = z
getAnnS (Write    z _ _  ) = z
getAnnS (AwaitInp z _ _  ) = z
getAnnS (EmitExt  z _ _  ) = z
getAnnS (AwaitTmr z _    ) = z
getAnnS (AwaitEvt z _ _  ) = z
getAnnS (EmitEvt  z _ _  ) = z
getAnnS (Break    z      ) = z
getAnnS (If       z _ _ _) = z
getAnnS (Seq      z _ _  ) = z
getAnnS (Loop     z _    ) = z
getAnnS (Every    z _ _ _) = z
getAnnS (And      z _ _  ) = z
getAnnS (Or       z _ _  ) = z
getAnnS (Par      z _ _  ) = z
getAnnS (Spawn    z _    ) = z
getAnnS (Pause    z _ _  ) = z
getAnnS (Fin      z _ _ _) = z
getAnnS (Async    z _    ) = z
getAnnS (Trap     z _ _  ) = z
getAnnS (Escape   z _ _  ) = z
getAnnS (Scope    z _    ) = z
getAnnS (Error    z _    ) = z
getAnnS (Var'     z _ _ _ _) = z
getAnnS (Inp'     z _ _ _) = z
getAnnS (Out'     z _ _ _) = z
getAnnS (Evt'     z _ _ _) = z
